...
/// parallel, so compile this first and let each scenario spend its timeout on
/// the protocol instead of on startup.
///
/// ```sh
...
/// The revision these scenarios run at when the suite names none.
...
Future<void> _runScenario(
  ...
  switch (scenario) {
    ...
    case _refDereferenceScenario:
      ...
      // network `$ref` the tool's input schema points at.
      await connection.listTools();
    default:
      throw ArgumentError.value(
        scenario,
...
/// of them null, so the suite supplies them, not this file.
